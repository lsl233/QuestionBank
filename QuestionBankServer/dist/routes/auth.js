    ...
    authRouter.post('/test-login', async (c) => {
        ...
        try {
            ...
            if (existing.rows.length === 0) {
                const inserted = await query('INSERT INTO users (apple_user_id, email, name) VALUES ($1, $2, $3) RETURNING id, apple_user_id, email, name', [testAppleUserId, 'test@example.com', '测试用户']);
