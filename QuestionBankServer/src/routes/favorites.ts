...
import type { Favorite, Paper, User } from '../types/index.js'
...
function toFavorite(row: Record<string, unknown>, paper?: Paper): Favorite {
  return {
...
favoritesRouter.post('/', async (c) => {
  ...
  await query(
    `INSERT INTO favorites (user_id, paper_id) VALUES ($1, $2)
